...
static int aeApiAddEvent(aeEventLoop *eventLoop, int fd, int mask) {
    ...
    ee.events = EPOLLPRI | EPOLLERR | EPOLLHUP | EPOLLET;
...
aeEventLoop *aeCreateEventLoop(void) {
    ...
    int i;
    aeEventLoop *eventLoop = (aeEventLoop*)malloc(sizeof(*eventLoop));
...
//according mask to set callback function
